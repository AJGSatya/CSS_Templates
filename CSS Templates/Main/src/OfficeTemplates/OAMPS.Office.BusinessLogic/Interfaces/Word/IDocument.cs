...
namespace OAMPS.Office.BusinessLogic.Interfaces.Word
{
    public interface IDocument
    {
        ...
        int GetBookmarkStartRange(string bookmarkName);
        int GetBookmarkEndRange(string bookmarkName);
        ...
        string GetPropertyValue(string propertyName, bool trySharePointProperties = true);
