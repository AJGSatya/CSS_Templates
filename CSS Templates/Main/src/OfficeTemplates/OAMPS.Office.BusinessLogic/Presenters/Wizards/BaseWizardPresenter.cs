    ...
    public class BaseWizardPresenter
    {
        ...
        public void OnDocumentLoadCompleted(int protectionType)
        {
            ...
            Task.Factory.StartNew(() =>
            {
                ...
                {
                    Document.CloseInformationPanelOnAllDocuments();
                    Thread.Sleep(1000);
                }
        ...
        public void PopulateGraphics(IBaseTemplate template, string previousCoverPageTitle, string previousLogoTitle)
        {
            ...
            Document.UpdateOrCreatePropertyValue(Constants.WordDocumentProperties.CoverPageTitle,
                template.CoverPageTitle);
        ...
        public void CloseDocument(bool saveChanges, bool delay)
        {
            Document.CloseMe(saveChanges, delay);
        }
