...
namespace OAMPS.Office.Word.Views.Word
{
    ...
    {
        private readonly List<IDocument> _convertedDocuments = new List<IDocument>();
        ...
        private IDocument DoConvert(QuoteSlipSchedules i, IBaseTemplate template)
        {
            ...
            _presenter.ConvertToQuoteSlip(Settings.Default.TemplateQuoteSlip, quoteSlipDoc, i, template);
            return quoteSlipDoc;
        }
