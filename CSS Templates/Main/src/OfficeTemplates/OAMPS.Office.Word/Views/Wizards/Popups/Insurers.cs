...
// ReSharper restore ConditionIsAlwaysTrueOrFalse
        ...
        private List<IInsurer> GetInsurers(string type)
        {
            ...
            {
                var list = ListFactory.Create(Settings.Default.ApprovedInsurersListName);
        ...
        private void GetSelectedInsurers(DataGridView dataGridView, List<IInsurer> storageCollection)
        {
                    ...
                    switch (cell.OwningColumn.HeaderText)
                    {
                        ...
                        case "%":
                            if (cell.EditedFormattedValue != null)
                                decimal.TryParse(cell.EditedFormattedValue.ToString(), out percent);
            ...
            {
                MessageBox.Show(
                    @"Your selected insurers do not total 100%, Please correct the % for the selected insurers.");
        ...
        {
            FindResult(txtFindRecommended.Text, dgvRecommended, _reccommendedInsurers,
                Constants.CacheNames.ReccomendedInsuerData);
        }
