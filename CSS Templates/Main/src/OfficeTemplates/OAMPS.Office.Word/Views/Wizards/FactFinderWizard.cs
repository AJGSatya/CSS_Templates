...
namespace OAMPS.Office.Word.Views.Wizards
{
    public partial class FactFinderWizard : BaseWizardForm
    {
        ...
        public FactFinderWizard(OfficeDocument document, Helpers.Enums.FormLoadType loadType)
        {
            InitializeComponent();
            ...
            clbQustions.ItemCheck += clbQustions_ItemCheck;
            ...
            //ShouldUpdateTemplate(Settings.Default.TemplateLibraryName, "Pre-Renewal Questionnaire.docx");
        }
        ...
        private void RetickQuestionsOnReload(bool isRegenProcess)
        {
            ...
            for (var i = 0; i < clbQustions.Items.Count; i++)
            {
        ...
        private void LoadQuestions(TaskScheduler uiScheduler)
        {
            ...
            else
            {
                Questions = LoadQuestionsFromSharePoint(Settings.Default.SharePointContextUrl,
                    Settings.Default.PreRenewalQuestionareMappingsListName);
