...
//            var heading = Globals.ThisAddIn.Application.Selection.Text;
            ...
            var heading = _wizardPresenter.FindHeadingTextForCurrentDocument();

            webHelpWindow.DocumentText = GetHelpContentFromSharePoint(heading, Settings.Default.SharePointContextUrl,
                Settings.Default.HelpContentListName, templateName);
