...
namespace OAMPS.Office.BusinessLogic.Presenters.Wizards
{
    public class GenericLetterWizardPresenter : BaseWizardPresenter
    {
        ...
        public void InsertSubFragments(string attachmentBookMark, string mainContentBookMark, List<DocumentFragment> fragements, string fragUrl)
        {
            string frgKeys = null;
            ...
            for (var i = 0; i < fragements.Count; i++)
            {
                ...
                var b = fragements[i];
                d.MoveCursorToStartOfBookmark(b.Locked.Equals("true", StringComparison.OrdinalIgnoreCase) ? "Locked" : "Unlocked");
