...
namespace OAMPS.Office.Word.Views.Wizards.Popups
{
    public partial class Insurers : BaseForm
    {
        ...
        private void txtFindCurrent_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                var found =
                    _currentInsurers.FindAll(
                        i => i.Title.ToLowerInvariant().Contains(txtFindCurrent.Text.ToLowerInvariant()));//(txtFindCurrent.Text,StringComparison.OrdinalIgnoreCase));
        ...
        private void txtFindRecommended_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                var found =
                    _reccommendedInsurers.FindAll(
                        i => i.Title.ToLowerInvariant().Contains(txtFindRecommended.Text.ToLowerInvariant()));// StartsWith(txtFindRecommended.Text,StringComparison.OrdinalIgnoreCase));
