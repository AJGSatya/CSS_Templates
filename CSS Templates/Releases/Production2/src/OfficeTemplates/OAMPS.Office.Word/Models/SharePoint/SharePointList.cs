...
namespace OAMPS.Office.Word.Models.SharePoint
{
    public class SharePointList : ISharePointList
    {
        ...
        {
            var test = "<Where><Eq><FieldRef Name='Title' /><Value Type='Text'>" + title + "</Value></Eq></Where>";// string.Format(Constants.SharePointQueries.GetItemByTitleQuery, title);
        ...
        public void AddItem(Dictionary<string, string> fieldValues)
        {
            ...
            var listItem = _list.AddItem(itemCreateInfo);
