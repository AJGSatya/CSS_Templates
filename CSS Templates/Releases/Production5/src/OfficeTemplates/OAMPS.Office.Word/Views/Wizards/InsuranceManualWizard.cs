...
// ReSharper restore LoopCanBeConvertedToQuery
        ...
        private void ReloadPolicyClasses(IInsuranceManual v, bool reload)
        {
            ...
            for (var index = v.SelectedPolicyClasses.Count - 1; index >= 0; index--)
            {
                ...
                foreach (var no in tvaPolicies.AllNodes)
                {
                    ...
                    if (!String.Equals(no.Tag.ToString(), found.MajorClass, StringComparison.OrdinalIgnoreCase)) continue;
        ...
        private void PopulateDocument()
        {
            ...
            var urls = (from object i in clbClaimsProcedures.CheckedItems select ((SharePointListItem)i).FileRef).ToList();
