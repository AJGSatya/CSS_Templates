...
namespace OAMPS.Office.Word.Views.Wizards
{
    public partial class RenewalLetterWizard : BaseWizardForm
    {
        ...
        {
            string value = _wizardPresenter.ReadDocumentProperty(proName);
            bool isSelected;
            if (Boolean.TryParse(value, out isSelected))
            {
...
// ReSharper restore LoopCanBeConvertedToQuery
        ...
        private void AddMainFragment(RenewalLetter template)
        {
            ...
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLNoContact_ExistingInsr_NoGAW_NoFunding, template);
            }
            else if (chkContacted.Checked && !chkNewInsurer.Checked && !chkGAW.Checked && !chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLYesContact_ExistingInsr_NoGAW_NoFunding, template);
            }
            else if (!chkContacted.Checked && !chkNewInsurer.Checked && chkGAW.Checked && !chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLNoContact_ExistingInsr_YesGAW_NoFunding, template);
            }
            else if (chkContacted.Checked && !chkNewInsurer.Checked && chkGAW.Checked && !chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLYesContact_ExistingInsr_YesGAW_NoFunding, template);
            }
            else if (!chkContacted.Checked && !chkNewInsurer.Checked && chkGAW.Checked && chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLNoContact_ExistingInsr_YesGAW_YesFunding, template);
            }
            else if (chkContacted.Checked && !chkNewInsurer.Checked && chkGAW.Checked && chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLYesContact_ExistingInsr_YesGAW_YesFunding, template);
            }
            else if (chkContacted.Checked && !chkNewInsurer.Checked && !chkGAW.Checked && chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLYesContact_ExistingInsr_NoGAW_YesFunding, template);
            }
            else if (!chkContacted.Checked && chkNewInsurer.Checked && !chkGAW.Checked && !chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLNoContact_NewInsr_NoGAW_NoFunding, template);
            }
            else if (chkContacted.Checked && chkNewInsurer.Checked && !chkGAW.Checked && !chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLYesContact_NewInsr_NoGAW_NoFunding, template);
            }
            else if (!chkContacted.Checked && chkNewInsurer.Checked && chkGAW.Checked && !chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLNoContact_NewInsr_YesGAW_NoFunding, template);
            }
            else if (chkContacted.Checked && chkNewInsurer.Checked && chkGAW.Checked && !chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLYesContact_NewInsr_YesGAW_NoFunding, template);
            }
            else if (!chkContacted.Checked && chkNewInsurer.Checked && chkGAW.Checked && chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLNoContact_NewInsr_YesGAW_YesFunding, template);
            }
            else if (chkContacted.Checked && chkNewInsurer.Checked && chkGAW.Checked && chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLYesContact_NewInsr_YesGAW_YesFunding, template);
            }
            else if (!chkContacted.Checked && chkNewInsurer.Checked && !chkGAW.Checked && chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLNoContact_NewInsr_NoGAW_YesFunding, template);
            }
            else if (chkContacted.Checked && chkNewInsurer.Checked && !chkGAW.Checked && chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLYesContact_NewInsr_NoGAW_YesFunding, template);
            }
            else if (!chkContacted.Checked && !chkNewInsurer.Checked && !chkGAW.Checked && chkFunding.Checked)
            {
                _wizardPresenter.InsertMainFragment(Constants.WordBookmarks.RenewalLetterMain, Settings.Default.FragmentRLNoContact_ExistingInsr_NoGAW_YesFunding, template);
            }
        }
        ...
        private void SetPaymentDate()
        {
            if (datePayment != null)
            {
                ...
                datePayment.Value = dateReport.Value.AddDays(14) < datePolicy.Value.Date ? datePolicy.Value : dateReport.Value.AddDays(14);
