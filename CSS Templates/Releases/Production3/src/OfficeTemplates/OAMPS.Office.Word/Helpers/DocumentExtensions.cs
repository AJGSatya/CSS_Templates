...
// ReSharper restore EmptyGeneralCatchClause
        ...
        public static string GetPostalAddressFragment(this string office, bool isPart1)
        {
            ...
            var list = new SharePointList(Properties.Settings.Default.SharePointContextUrl, "Office Addresses",BusinessLogic.Helpers.Constants.SharePointQueries.GetItemByTitleQuery);
        ...
        public static void LoadWizard(this Document document, Enums.FormLoadType loadType)
        {
            ...
            var templateName = ((DocumentProperties) (Globals.ThisAddIn.Application.ActiveDocument.BuiltInDocumentProperties))[WdBuiltInProperty.wdPropertyTitle].Value.ToString();

            if (!String.IsNullOrEmpty(templateName))
            {
                if (String.Equals(templateName, BusinessLogic.Helpers.Constants.TemplateNames.PlacementSlip, StringComparison.OrdinalIgnoreCase))
                {

                }
                else if (String.Equals(templateName, BusinessLogic.Helpers.Constants.TemplateNames.FileNote, StringComparison.OrdinalIgnoreCase)) //we do not show this wizard on docload.
                {
                ...
                else if (String.Equals(templateName, BusinessLogic.Helpers.Constants.TemplateNames.PreRenewalAgenda, StringComparison.OrdinalIgnoreCase))
                {
                ...
                else if (String.Equals(templateName, BusinessLogic.Helpers.Constants.TemplateNames.InsuranceRenewalReport, StringComparison.OrdinalIgnoreCase))
                {
                ...
                else if (String.Equals(templateName, BusinessLogic.Helpers.Constants.TemplateNames.RenewalLetter, StringComparison.OrdinalIgnoreCase))
                {
                ...
                else if (String.Equals(templateName, BusinessLogic.Helpers.Constants.TemplateNames.ClientDiscovery, StringComparison.OrdinalIgnoreCase))
                {
                ...
                else if (String.Equals(templateName, BusinessLogic.Helpers.Constants.TemplateNames.PreRenewalQuestionnaire, StringComparison.OrdinalIgnoreCase))
                {
                    var wizard = new PreRenewalQuestionareWizard(officeDoc, loadType)
                    {
                        TopMost = true,
                        StartPosition = FormStartPosition.CenterParent,
                        Reload = (loadType != Enums.FormLoadType.OpenDocument)
                ...
                else if (String.Equals(templateName, BusinessLogic.Helpers.Constants.TemplateNames.GenericLetter, StringComparison.OrdinalIgnoreCase))
                {
