    ...
    public class BaseForm : Form, IBaseView, INotifyPropertyChanged
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            if (BasePresenter != null)
            {
                ...
                BasePresenter.CloseInformationPanel(true);
            }
        ...
        public virtual void PopulateDocument(IBaseTemplate template, string coverpageTitle, string logoTitle)
        {
            ...
            BasePresenter.PopulateGraphics(template,coverpageTitle,logoTitle);
        }
        ...
        {
            this.LoadTreeViewClasses(uiScheduler);
