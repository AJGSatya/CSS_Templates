...
namespace OAMPS.Office.Word.Views.Wizards
{
    public partial class ClientDiscoveryWizard : BaseForm
    {
            ...
            var clientDiscovery = new ClientDiscovery
                {
                    ...
                    DatePrepared = datePrepared.Value.ToString(CultureInfo.InvariantCulture)
                };
        ...
        private void chkSelectAll_CheckedChanged(object sender, EventArgs e)
        {
            ...
            foreach (var node in tvaQuestions.AllNodes.Select(n => tvaQuestions.GetPath(n)).Select(path => ((AdvancedTreeNode)path.LastNode)))
            {
