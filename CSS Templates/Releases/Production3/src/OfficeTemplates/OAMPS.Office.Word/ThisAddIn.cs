    ...
    public partial class ThisAddIn
    {
        ...
        private void ThisAddIn_NewDocument(Document doc)
        {
            try
            {
                ...
                Globals.ThisAddIn.Application.ActiveDocument.UpdateOrCreatePropertyValue(BusinessLogic.Helpers.Constants.WordDocumentProperties.DocumentId, Guid.NewGuid().ToString());
