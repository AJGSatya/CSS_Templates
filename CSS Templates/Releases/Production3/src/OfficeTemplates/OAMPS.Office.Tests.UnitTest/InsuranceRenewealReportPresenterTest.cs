...
namespace OAMPS.Office.Tests.UnitTest
{
    ...
    public class InsuranceRenewealReportPresenterTest
    {
        ...
        public class UnitTestDocument : IDocument
        {
            ...
            {
                this.MockPageCount = PageCount - 1;
            }
            ...
            {
                foreach (var p in  MockDocumentProperties)
                {
            ...
            public void OpenFile(string path, string cacheName)
            {
                throw new NotImplementedException();
            }
            ...
            {
                InsertedPageBreaks.Add(DateTime.Now.Second.ToString());
            }
        ...
        {
            var document = new UnitTestDocument();
            document.MockBookmarks = new List<string> {"aBookMark", "bBookMark", "cBookMark"};
