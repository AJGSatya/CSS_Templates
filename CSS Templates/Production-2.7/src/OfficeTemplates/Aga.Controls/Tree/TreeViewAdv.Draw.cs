    ...
    public partial class TreeViewAdv
    {
        ...
        private void DrawRow(PaintEventArgs e, ref DrawContext context, int row, Rectangle rowRect)
        {
            ...
            if (FullRowSelect)
            {
                ...
                {
                    var focusRect = new Rectangle(OffsetX, rowRect.Y, ClientRectangle.Width, rowRect.Height);
        ...
        private void DrawColumnHeaders(Graphics gr)
        {
            ...
            var reorder = Input as ReorderColumnState;
            int x = 0;
            ...
            foreach (TreeColumn c in Columns)
            {
                if (c.IsVisible)
                {
                    ...
                    {
                        var rect = new Rectangle(x, 0, c.Width, ColumnHeaderHeight - 1);
                        gr.SetClip(rect);
